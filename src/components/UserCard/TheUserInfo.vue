...
<div :class="[variant, { 'radient-border-passthrough': variant != 'nav' && variant != 'home' }]" class="user-card">
    ...
    <button v-if="variant === 'home'" class="notif-wrapper" type="button" aria-label="Notifications" :aria-expanded="stateStore.notificationsOpen" aria-controls="notifications-drawer" @click="openNotifications">
...
async function openNotifications() {
    ...
    try {
        const {
            data
        } = await UserService.getIsSubscribed()
