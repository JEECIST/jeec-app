<template>
    <div>
        ...
        <div class="squad-card">
            ...
            <newMember :members="squad.members?.data"></newMember>
...
watch(() => props.squad, (newVal) => {
    console.log('Squad data arrived:', newVal)
}, { immediate: true }) // immediate: true runs it once right away as well
